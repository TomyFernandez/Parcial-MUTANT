...
public class MutantRepositoryTest {
    ...
    @Test
    public void testSaveIfNotExists_DuplicateDna() {
        Mutant mutant1 = Mutant.builder()
                .nombre("Nombre1")
                .apellido("Apellido1")
                .poder("Poder1")
        ...
        Mutant savedMutant = mutantRepository.saveIfNotExists(mutant2);
        Assert.assertEquals(mutant1.getId(), savedMutant.getId());
    }
}